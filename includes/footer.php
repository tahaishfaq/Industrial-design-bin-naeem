...
<footer class="bg-surface py-24 px-6 md:px-12 mt-12 border-t border-edge">
  <div class="max-w-[1600px] mx-auto">
    <span class="text-sm font-medium text-muted block mb-8">Contact Us</span>

    <!-- Main Contact Section: Let's Discuss -->
    <div class="mb-24">
      <h2 class="font-display text-6xl md:text-8xl lg:text-9xl text-content leading-none tracking-tight">
        Let's <span class="text-muted">discuss</span> your <br />
        vision
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10">
        ...
        <div class="space-y-4">
          ...
          <div class="text-sm text-muted leading-relaxed">
            ...
            <p class="mt-3 text-content font-medium">
              <a href="tel:+924237311809" class="hover:underline ga-contact" data-ga-method="phone">+92-42-37311809</a><br />
              <a href="tel:+923215707070" class="hover:underline ga-contact" data-ga-method="phone">+92-3215707070</a><br />
              <a href="mailto:info@binnaeemindustries.com" class="hover:underline ga-contact" data-ga-method="email">info@binnaeemindustries.com</a>
            </p>
          </div>
        </div>
        ...
        <div class="flex flex-col items-start md:items-end justify-between gap-4">
          <div>
            <h3 class="text-xs font-semibold uppercase tracking-[0.15em] text-muted mb-4">Connect</h3>
            <div class="flex items-center gap-4">
              <a href="https://www.instagram.com/binnaeemindustries?igsh=YXB0bTUyYW45d2Fv" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram" class="w-10 h-10 rounded-full border border-edge flex items-center justify-center text-muted hover:text-content hover:border-content transition-all">
              ...
              <a href="<?php echo htmlspecialchars(waUrl('footer'), ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer" aria-label="Contact us on WhatsApp" class="w-10 h-10 rounded-full border border-edge flex items-center justify-center text-muted hover:text-content hover:border-content transition-all">
              ...
              <a href="https://www.facebook.com/binnaeemindustries" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook" class="w-10 h-10 rounded-full border border-edge flex items-center justify-center text-muted hover:text-content hover:border-content transition-all">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div class="text-xs text-muted pt-4 text-left md:text-right">
